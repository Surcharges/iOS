...
FILE_PATH=$CI_PRIMARY_REPOSITORY_PATH/Surcharges/Applications/Resources/Dev/GoogleService-Info.plist
...
echo "<string>nz.surcharges.development</string>" >> $FILE_PATH
echo "<key>PROJECT_ID</key>" >> $FILE_PATH
echo "<string>surcharges-dev</string>" >> $FILE_PATH
