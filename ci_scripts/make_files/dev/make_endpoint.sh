...
FILE_PATH=$CI_PRIMARY_REPOSITORY_PATH/Surcharges/DataSource/Endpoints/DevelopmentEndpoint/Sources/DevelopmentEndpoint.swift

echo "import Foundation" >> $FILE_PATH
echo "import EndpointProtocol" >> $FILE_PATH
echo "public struct DevelopmentEndpoint: EndpointProtocol {" >> $FILE_PATH
