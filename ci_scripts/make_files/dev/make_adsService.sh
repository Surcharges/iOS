...
FILE_PATH=$CI_PRIMARY_REPOSITORY_PATH/Surcharges/Shared/Services/Ads/DevelopmentAdsService/Sources/DevelopmentAdsService.swift

echo "import Foundation" >> $FILE_PATH
echo "import AdsServiceProtocol" >> $FILE_PATH
echo "public final class DevelopmentAdsService: AdsServiceProtocol {" >> $FILE_PATH
